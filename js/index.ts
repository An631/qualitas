...
function getBinding() {
  ...
  try {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-require-imports -- Native binding loaded dynamically via require()
  ...
  for (const pkg of platforms) {
    try {
      // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-require-imports -- Platform-specific binding loaded dynamically
