...
import { renderFileReport, renderProjectReport } from '../../js/reporters/text.js';
import { renderJsonReport } from '../../js/reporters/json.js';
import { renderMarkdownReport } from '../../js/reporters/markdown.js';
...
describe('renderJsonReport', () => {
  it('produces valid JSON with score, grade, and functions', () => {
...
describe('renderMarkdownReport', () => {
  it('contains function table with expected headers', () => {
    const report = analyzeSource(CLEAN_SRC, 'clean.ts');
...
describe('renderFileReport', () => {
  it('verbose mode shows metric labels', () => {
  ...
  it('flaggedOnly hides clean functions', () => {
    const report = analyzeSource(CLEAN_SRC, 'clean.ts');
...
describe('renderProjectReport', () => {
  it('includes grade distribution counts', () => {
