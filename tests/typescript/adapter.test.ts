...
`;
  ...
  it(
    'returns no flags for simple utility',
    skipIfNoBinding(() => {
      const src = `
...
`;
  ...
  it(
    'flags TOO_LONG for functions over 40 lines',
    skipIfNoBinding(() => {
  ...
  it(
    'flags DEEP_NESTING for > 4 levels',
    skipIfNoBinding(() => {
      const src = `
function f(a: any) {
  if (a) {
...
describe('TypeScript — SourceLocation line numbers', () => {
  it(
    'reports 1-based line numbers (not byte offsets)',
    skipIfNoBinding(() => {
      const src = [
        '// line 1',
        '// line 2',
  ...
  it(
    'startLine of second function is after first function',
    skipIfNoBinding(() => {
      const src = `
...
describe('TypeScript — dependency coupling', () => {
  it(
    'detects distinct API calls from imported module bindings',
    skipIfNoBinding(() => {
      const src = `
import fs from 'fs';
...
`;
  ...
  it(
    'reports file-level import count and external packages',
    skipIfNoBinding(() => {
      const src = `
...
`;
  ...
  it(
    'reports zero DC for functions with no import API calls',
    skipIfNoBinding(() => {
...
describe('TypeScript — identifier reference complexity', () => {
  it(
    'computes non-zero IRC for variables used across many lines',
    skipIfNoBinding(() => {
      const src = `
...
`;
  ...
  it(
    'flags HIGH_IDENTIFIER_CHURN when IRC exceeds error threshold',
    skipIfNoBinding(() => {
      const lines = [
...
describe('TypeScript — function collection patterns', () => {
  it(
    'collects object literal arrow functions with property key names',
    skipIfNoBinding(() => {
      const src = `
const handlers = {
...
`;
  ...
  it(
    'collects object literal function expressions with property key names',
    skipIfNoBinding(() => {
      const src = `
const api = {
...
`;
  ...
  it(
    'collects export default arrow functions',
    skipIfNoBinding(() => {
  ...
  it(
    'collects export default named function',
    skipIfNoBinding(() => {
      const src = `
...
`;
  ...
  it(
    'collects class property arrows as class methods',
    skipIfNoBinding(() => {
      const src = `
class EventHandler {
...
describe('TypeScript — arrow functions', () => {
  it(
    'collects and analyzes const arrow functions',
    skipIfNoBinding(() => {
      const src = `
...
`;
  ...
  it(
    'reports isAsync=true for async functions',
    skipIfNoBinding(() => {
...
describe('TypeScript — class analysis', () => {
  it(
    'collects class methods and aggregates class score',
    skipIfNoBinding(() => {
      const src = `
class Calculator {
...
`;
  ...
  it(
    'class with complex methods scores lower than class with simple methods',
    skipIfNoBinding(() => {
      const simpleClass = `
class A {
